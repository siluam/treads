{
  ...
  description = "The base nix layer for all my packages!";
  inputs = rec {
    ...
    siluam.url = "github:siluam/siluam";
  };

  # Adapted From: https://github.com/crazazy/niv-flakes/blob/master/flake.nix#L21C1-L21C56
  outputs = inputs@{ siluam, ... }:
    import ./outputs.nix (siluam.lib.mkInputs {
      src = ./.;
      inherit inputs;
    });
}
